...
export class ExampleWorker extends WorkerHost {
  ...
  private async downloadFile(fileId: string): Promise<Buffer> {
    ...
    void fileId; // Placeholder to avoid unused variable error
  ...
  private async extractText(buffer: Buffer): Promise<string> {
    ...
    void buffer; // Placeholder to avoid unused variable error
    await this.sleep(1000);
  ...
  private async generateNotes(text: string): Promise<string> {
    ...
    void text; // Placeholder to avoid unused variable error
  ...
  private async saveNotes(
    ...
    void notes; // Placeholder to avoid unused variable error
    void userId; // Placeholder to avoid unused variable error
    await this.sleep(500);
